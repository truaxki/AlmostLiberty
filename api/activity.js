    ...
    async function activityFun(req, res) {
        ...
        client.get(location, async (err, data) => {
            ...
            if (data) {
                ...
                console.log(`Cache miss: No cached data for location: ${location}. Making API call to Gemini.`);
                ...
                try {
                    ...
                    if (match) {
                        try {
                            ...
                            client.setex(location, 604800, JSON.stringify(parsedObject)); // Cache data for 1 week
